// @Description Rewritten_Sub_80536A8_EntityAI_0x0E_Tmain_boss_takarabako
// @HookAddress 0x78E838
// @HookString P
// Made by beco
// Verison 1.0
...
#define Sub_80536A8_EntityAI_0x0E_Tmain_boss_takarabako ((void (*)()) 0x80536A9)
...
const short zako_pencil_Obj_test[] = {
    ...
    0x40F0, 0x8020, 0x8204
};

const struct TAnmDef zako_pencil_Anm_test[] = {{zako_pencil_Obj_test, 0xC8, 0, 0, 0}, {0, 0, 0, 0, 0}};

void Rewritten_Sub_80536A8_EntityAI_0x0E_Tmain_boss_takarabako() {
    if (CurrentLevel == 4 && CurrentRoomId == 2) {
        // Vanilla code
        Sub_80536A8_EntityAI_0x0E_Tmain_boss_takarabako();
    } else {
        // Custom code
        switch (CurrentEnemyData.CurEnemy_CurrentAnimationId) {
            case Q_INITIAL:
                // Sub_80595FC_Q_INITIAL_zako_pencil();
                ...
                break;
            case Q_K2_LEFT:
                Sub_8059680_Q_K2_LEFT_zako_pencil();
                break;
            case K2_LEFT:
                Sub_80596CC_K2_LEFT_zako_pencil();
                break;
            case Q_K2_RIGHT:
                Sub_80596F4_Q_K2_RIGHT_zako_pencil();
                break;
            case K2_RIGHT:
                Sub_8059740_K2_RIGHT_zako_pencil();
                break;
            default:
                break;
        }
