// @Description Rewritten_Sub_80682FC_EntityAI_0xF2_Tmain_mouja_zako_hammer
// @HookAddress 0x78EBC8
// @HookString P
// Made by beco
// Verison 1.0
...
#define Sub_80682FC_EntityAI_0xF2_Tmain_mouja_zako_hammer ((void (*)()) 0x80682FD)
#define EntityCollision ((int (*)(int, int)) 0x8026211)

#define sin_cos_table ((signed short*) 0x8095138)

void Rewritten_Sub_80682FC_EntityAI_0xF2_Tmain_mouja_zako_hammer() {
    // Vanilla code
    Sub_80682FC_EntityAI_0xF2_Tmain_mouja_zako_hammer();

    // Custom code
    if (CurrentEnemyData.CurEnemy_GuardAndDamageParam == MOTSU && Wario_ucReact == 7 && Wario_ucStat == 7) {
