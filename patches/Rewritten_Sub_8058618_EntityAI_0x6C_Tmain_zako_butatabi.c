// @Description Rewritten_Sub_8058618_EntityAI_0x6C_Tmain_zako_butatabi
// @HookAddress 0x78E9B0
// @HookString P
// Made by beco
// Verison 1.0
...
#define Sub_8058618_EntityAI_0x6C_Tmain_zako_butatabi ((void (*)()) 0x8058619)
#define Sub_80583E0_Q_INITIAL_zako_butatabi ((void (*)()) 0x80583E1)
#define Sub_805844C_Q_K2_COM_zako_butatabi ((void (*)()) 0x805844D)
#define Sub_8058498_Q_K2_LEFT_zako_butatabi ((void (*)()) 0x8058499)
#define Sub_80584AC_Q_K2_RIGHT_zako_butatabi ((void (*)()) 0x80584AD)
#define Sub_80584C0_Q_TD_ATA_COM_zako_butatabi ((void (*)()) 0x80584C1)
#define Sub_80584F8_Q_TD_ATA_L_zako_butatabi ((void (*)()) 0x80584F9)
#define Sub_805850C_Q_TD_ATA_R_zako_butatabi ((void (*)()) 0x805850D)
#define Sub_8058520_K0_WALK_zako_butatabi ((void (*)()) 0x8058521)
#define EntityCollision ((int (*)(int, int)) 0x8026211)

void Rewritten_Sub_8058618_EntityAI_0x6C_Tmain_zako_butatabi() {
    // Vanilla code
    // Sub_8058618_EntityAI_0x6C_Tmain_zako_butatabi();

    // Custom code
    switch (CurrentEnemyData.CurEnemy_CurrentAnimationId) {
        case Q_INITIAL:
            Sub_80583E0_Q_INITIAL_zako_butatabi();
            Sub_8026308_WarioOrientedStart();
            break;
        case Q_K2_LEFT:
        case Q_K4_LEFT:
        case Q_K2D_LEFT:
            Sub_8058498_Q_K2_LEFT_zako_butatabi();
            break;
        case K2_LEFT:
        ...
        case Q_K4_RIGHT:
        case Q_K2D_RIGHT:
            Sub_80584AC_Q_K2_RIGHT_zako_butatabi();
            break;
        case K2_RIGHT:
        ...
        case Q_K5_HIP:
            ...
            break;
        case Q_TD_ATA_R:
            Sub_805850C_Q_TD_ATA_R_zako_butatabi();
            break;
        case Q_TD_ATA_L:
            Sub_80584F8_Q_TD_ATA_L_zako_butatabi();
            break;
        default:
            CurrentEnemyData.CurEnemy_CurrentAnimationId = K0_WALK;
            Sub_8058520_K0_WALK_zako_butatabi();
            break;
    }
}
