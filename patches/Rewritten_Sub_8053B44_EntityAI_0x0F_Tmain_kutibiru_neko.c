// @Description Rewritten_Sub_8053B44_EntityAI_0x0F_Tmain_kutibiru_neko (Jyabara, open from left)
// @HookAddress 0x78E83C
// @HookString P
// Made by beco
// Verison 1.0
...
#define zako_jyabara_Anm_00 ((unsigned long*) 0x83DD720)
#define zako_jyabara_Anm_01 ((unsigned long*) 0x83DD730)
#define zako_jyabara_Anm_02 ((unsigned long*) 0x83DD758)
...
#define Sub_801E0EC_EnemySet ((void (*)(char, char, char, int, int)) 0x801E0ED)
...
#define Sub_8059834_HIT_RETURN_zako_jyabara ((void (*)()) 0x8059835)
#define Sub_80598F8_HIT_CLEAR_zako_jyabara ((void (*)()) 0x80598F9)
#define Sub_80599BC_Q_INITIAL_zako_jyabara ((void (*)()) 0x80599BD)
#define Sub_8059A20_K0_WALK_zako_jyabara ((void (*)()) 0x8059A21)
#define Sub_8059A9C_K0_TURN1_zako_jyabara ((void (*)()) 0x8059A9D)
#define Sub_8053B44_EntityAI_0x0F_Tmain_kutibiru_neko ((void (*)()) 0x8053B45)
...
const struct TAnmDef zako_jyabara_Anm_Closing[] = {{0x83DD706, 6, 0, 0, 0}, {0x83DD6EC, 6, 0, 0, 0}, {0x83DD6BA, 6, 0, 0, 0}, {0x83DD688, 6, 0, 0, 0}, {0, 0, 0, 0, 0}};

void Rewritten_Sub_8053B44_EntityAI_0x0F_Tmain_kutibiru_neko() {
    signed int v0;
    unsigned int v1;
    int v2;
    ...
    if (CurrentPassage == 5) {
        // Vanilla code
        Sub_8053B44_EntityAI_0x0F_Tmain_kutibiru_neko();
    } else {
        // Custom code
        switch (CurrentEnemyData.CurEnemy_CurrentAnimationId) {
            case Q_INITIAL:
                Sub_80599BC_Q_INITIAL_zako_jyabara();
                break;
            case K0_WALK:
                // Sub_8059A20_K0_WALK_zako_jyabara();
                v1 = (CurrentEnemyData.CurEnemy_YPos + 192) & 0xFFFF;
                v2 = v1 <= Wario_usPosY ? Wario_usPosY - v1 : v1 - Wario_usPosY;
                if (v2 < 128) {
                    if (CurrentEnemyData.CurEnemy_XPos > Wario_usPosX && CurrentEnemyData.CurEnemy_XPos - Wario_usPosX < 256) {
                        CurrentEnemyData.CurEnemy_CurrentAnimationId = K0_TURN1;
                        CurrentEnemyData.CurEnemy_TWork0 = 24;
                        CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_jyabara_Anm_01;
                        CurrentEnemyData.CurEnemy_RealFrameCountForCurrentAnimationFrame = 0;
                        CurrentEnemyData.CurEnemy_CurrentAnimationFrameId = 0;
                        Sub_80598F8_HIT_CLEAR_zako_jyabara();
                    }
                }
                break;
            case K0_TURN1:
                Sub_8059A9C_K0_TURN1_zako_jyabara();
                break;
            case JITTO:
            if ((CurrentEnemyData.CurEnemy_XPos <= Wario_usPosX && Wario_usPosX - CurrentEnemyData.CurEnemy_XPos >= 256) ||
            (CurrentEnemyData.CurEnemy_XPos > Wario_usPosX && CurrentEnemyData.CurEnemy_XPos - Wario_usPosX >= 256)) {
                    CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_jyabara_Anm_Closing;
                    CurrentEnemyData.CurEnemy_CurrentAnimationFrameId = 0;
                    CurrentEnemyData.CurEnemy_CurrentAnimationId = Q_JITTO;
                }
                break;
            case Q_JITTO:
                if (CurrentEnemyData.CurEnemy_CurrentAnimationFrameId >= 3) {
                    CurrentEnemyData.CurEnemy_CurrentAnimationId = Q_INITIAL;
                }
                break;
            default:
                break;
