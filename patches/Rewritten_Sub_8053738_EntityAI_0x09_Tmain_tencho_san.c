// @Description Rewritten_Sub_8053738_EntityAI_0x09_Tmain_tencho_san
// @HookAddress 0x78E824
// @HookString P
// Made by beco
// Verison 1.0
...
#define zako_takara_box_Anm_08 ((unsigned long*) 0x83B4FB4)
...
#define Sub_802920C_Q_INITIAL_takarabako ((void (*)()) 0x802920D)
#define Sub_802922C_Q_INITIAL2_takarabako ((void (*)()) 0x802922D)
#define Sub_8029258_Q_INITIAL3_takarabako ((void (*)()) 0x8029259)
#define Sub_8029264_Q_K2_COM_takarabako ((void (*)()) 0x8029265)
#define Sub_80292BC_Q_K5_HIP_COM_takarabako ((void (*)()) 0x80292BD)
#define Sub_80292F8_K5_HIP_COM_takarabako ((void (*)()) 0x80292F9)
#define Sub_8053738_EntityAI_0x09_Tmain_tencho_san ((void (*)()) 0x8053739)

const short zako_takara_box_Obj_test[] = {
    4,
    0x00E0, 0x41F0, 0x820C,
    0x00E0, 0x5000, 0x820C,
    0x00F0, 0x41F0, 0x820A,
    0x00F0, 0x5000, 0x820A
};

const struct TAnmDef zako_takara_box_Anm_test[] = {{zako_takara_box_Obj_test, 0xFF, 0, 0, 0}, {0, 0, 0, 0, 0}};

void Rewritten_Sub_8053738_EntityAI_0x09_Tmain_tencho_san() {
    if (CurrentLevel == 4) {
        // Vanilla code
        Sub_8053738_EntityAI_0x09_Tmain_tencho_san();
    } else {
        // Custom code
	    switch (CurrentEnemyData.CurEnemy_CurrentAnimationId) {
	        case Q_INITIAL:
	            CurrentEnemyData.CurEnemy_HitboxY0 = 120;
	            CurrentEnemyData.CurEnemy_GuardAndDamageParam = NORU_HAKO2_NH;
	            CurrentEnemyData.CurEnemy_CurrentAnimationId = K0_WALK;
	            CurrentEnemyData.CurEnemy_ucChrOfs = 7;
	            ...
	            CurrentEnemyData.CurEnemy_HitboxX0 = 60;
	            CurrentEnemyData.CurEnemy_HitboxX1 = 56;
	            ...
	            CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_takara_box_Anm_test;
	            break;
	        case Q_INITIAL2:
	            ...
	            CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_takara_box_Anm_08;
	            CurrentEnemyData.CurEnemy_padding = 50;
	            CurrentEnemyData.CurEnemy_HitboxY0 = 120;
	            CurrentEnemyData.CurEnemy_GuardAndDamageParam = NORU_HAKO2_NH;
	            CurrentEnemyData.CurEnemy_CurrentAnimationId = K0_WALK;
	            break;
	        ...
	        case Q_K4_RIGHT:
	            ...
	            CurrentEnemyData.CurEnemy_padding = 13;
	            CurrentEnemyData.CurEnemy_HitboxY0 = 64;
	            CurrentEnemyData.CurEnemy_GuardAndDamageParam = NORU_HAKO_NH;
	            EntityLeftOverStateList[64 * CurrentRoomId + CurrentEnemyData.CurEnemy_RoomEntitySlotId] = 17;
	            Sub_8001DA4_m4aSongNumStart(128);
	            Sub_8088620_WarioVoiceSet(11);
	        case K0_TURN1:
	        -- CurrentEnemyData.CurEnemy_padding;
	        if (CurrentEnemyData.CurEnemy_padding << 24) break;
	            CurrentEnemyData.CurEnemy_CurrentAnimationId = K5_HIP;
	            CurrentEnemyData.CurEnemy_RealFrameCountForCurrentAnimationFrame = 0;
	            CurrentEnemyData.CurEnemy_CurrentAnimationFrameId = 0;
	            CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_takara_box_Anm_08;
	            CurrentEnemyData.CurEnemy_padding = 50;
	            Sub_80766E8_TOptObjSet(CurrentEnemyData.CurEnemy_YPos - 64, CurrentEnemyData.CurEnemy_XPos - 28, KN_TUCHIKEMURI_L);
	            Sub_80766E8_TOptObjSet(CurrentEnemyData.CurEnemy_YPos - 64, CurrentEnemyData.CurEnemy_XPos + 28, KN_TUCHIKEMURI_R);
	            Sub_801E328_EnemyChildSet(
	                EntitySet[CurrentDifficulty],
	                CurrentEnemyData.CurEnemy_RoomEntitySlotId,
	                0,
	                CurrentEnemyData.CurEnemy_YPos - 64,
	                CurrentEnemyData.CurEnemy_XPos);
	        	for (int c = 0 ; c < 24 ; c ++) {
	        		if ((ENTITIES[c].CurEnemy_usStatus == 0x17 || ENTITIES[c].CurEnemy_usStatus == 0x57) && ENTITIES[c].CurEnemy_GlobalId == EntitySet[CurrentDifficulty]) {
	        			ENTITIES[c].CurEnemy_usStatus = ENTITIES[c].CurEnemy_usStatus & 0xFFFB;
	        			break;
	        		}
	        	}
	        ...
	        case K5_HIP:
	            if (EntityLeftOverStateList[64 * CurrentRoomId + CurrentEnemyData.CurEnemy_RoomEntitySlotId] == 33) {
	                --CurrentEnemyData.CurEnemy_padding;
	                if (!CurrentEnemyData.CurEnemy_padding) {
	                    CurrentEnemyData.CurEnemy_usStatus = CurrentEnemyData.CurEnemy_padding;
	                } else if (CurrentEnemyData.CurEnemy_padding <= 0x2Fu) {
	                    CurrentEnemyData.CurEnemy_DisableInteractionWithWarioCountdown = 1;
	                    if ( !(CurrentEnemyData.CurEnemy_padding & 1) ) {
	                        CurrentEnemyData.CurEnemy_usStatus = CurrentEnemyData.CurEnemy_usStatus ^ 4;
	                    }
	                }
	            }
	            break;
