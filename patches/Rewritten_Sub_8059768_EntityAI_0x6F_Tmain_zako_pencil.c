// @Description Rewritten_Sub_8059768_EntityAI_0x6F_Tmain_zako_pencil
// @HookAddress 0x78E9BC
// @HookString P
// Made by beco
// Verison 1.0
...
#define Sub_8059768_EntityAI_0x6F_0x70_0x71_Tmain_zako_pencil ((void (*)()) 0x8059769)
#define Sub_80595FC_Q_INITIAL_zako_pencil ((void (*)()) 0x80595FD)
#define Sub_8059680_Q_K2_LEFT_zako_pencil ((void (*)()) 0x8059681)
#define Sub_80596CC_K2_LEFT_zako_pencil ((void (*)()) 0x80596CD)
#define Sub_80596F4_Q_K2_RIGHT_zako_pencil ((void (*)()) 0x80596F5)
#define Sub_8059740_K2_RIGHT_zako_pencil ((void (*)()) 0x8059741)
#define Sub_8026838_EnemyWanderingCom ((void (*)()) 0x8026839)
#define EntityCollision ((int (*)(int, int)) 0x8026211)

const short zako_pencil_Obj_test[] = {
    7,
    0x40F0, 0x81C0, 0x8200,
    0x00F0, 0x41E0, 0x8202,
    0x00F0, 0x41F0, 0x8202,
    0x00F0, 0x4000, 0x8202,
    0x00F0, 0x4010, 0x8202,
    0x00F0, 0x4020, 0x8202,
    0x40F0, 0x8030, 0x8206
};

const struct TAnmDef zako_pencil_Anm_test[] = {{zako_pencil_Obj_test, 0xC8, 0, 0, 0}, {0, 0, 0, 0, 0}};

void Rewritten_Sub_8059768_EntityAI_0x6F_Tmain_zako_pencil() {
    if (CurrentPassage == 3 && CurrentLevel == 2 && CurrentRoomId == 14) {
        // Custom code
        switch (CurrentEnemyData.CurEnemy_CurrentAnimationId) {
            case Q_INITIAL:
                CurrentEnemyData.CurEnemy_usStatus |= 0x8408u;
                CurrentEnemyData.CurEnemy_GuardAndDamageParam = NORU_HAKO_NH;
                CurrentEnemyData.CurEnemy_SizeY0_Bottom = 20;
                CurrentEnemyData.CurEnemy_SizeY1_Top = 0;
                CurrentEnemyData.CurEnemy_SizeX_LeftRight = 20;
                CurrentEnemyData.CurEnemy_HitboxY0 = 64;
                CurrentEnemyData.CurEnemy_HitboxY1 = 0;
                CurrentEnemyData.CurEnemy_HitboxX0 = 255;
                CurrentEnemyData.CurEnemy_HitboxX1 = 255;
                ...
                CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_pencil_Anm_test;
                CurrentEnemyData.CurEnemy_TWork1 = 0;
                CurrentEnemyData.CurEnemy_XPos += 32;
                break;
            case Q_JITTO:
                for (int c = 0 ; c < 24 ; c ++) {
                    if (ENTITIES[c].CurEnemy_GlobalId == ZAKO_JYABARA && ENTITIES[c].CurEnemy_CurrentAnimationId == Q_JITTO) {
                        CurrentEnemyData.CurEnemy_CurrentAnimationId = K0_WALK;
                    }
                }
                /*
                if (CurrentEnemyData.CurEnemy_usStatus & 0x1000) {
                    CurrentEnemyData.CurEnemy_CurrentAnimationId = K0_WALK;
                }
                */
                break;
            case K0_WALK:
                if (CurrentEnemyData.CurEnemy_YPos <= 0x0240) {
        ...
        // Vanilla code
        Sub_8059768_EntityAI_0x6F_0x70_0x71_Tmain_zako_pencil();
    }
}
