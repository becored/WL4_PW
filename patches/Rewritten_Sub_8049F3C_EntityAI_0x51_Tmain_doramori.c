// @Description Rewritten_Sub_8049F3C_EntityAI_0x51_Tmain_doramori
// @HookAddress 0x78E944
// @HookString P
// Made by beco
// Verison 1.0
...
#define Sub_8049F3C_EntityAI_0x51_Tmain_doramori ((void (*)()) 0x8049F3D)
#define EntityCollision ((int (*)(int, int)) 0x8026211)

#define sin_cos_table ((signed short*) 0x8095138)

void Rewritten_Sub_8049F3C_EntityAI_0x51_Tmain_doramori() {
    // Vanilla code
