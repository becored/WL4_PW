// @Description Rewritten_Sub_804D57C_EntityAI_0x60_Tmain_zako_snowman
// @HookAddress 0x78E980
// @HookString P
// Made by beco
// Verison 1.0
enum {
...
#define unk_83D155C ((unsigned long*) 0x83D155C)
...
#define Sub_801E3A8_EnemyChildSet_LR ((void (*)(char, char, char, int, int, int)) 0x801E3A9)
...
#define Sub_804D57C_EntityAI_0x60_Tmain_zako_snowman ((void (*)()) 0x804D57D)
#define Sub_80766E8_TOptObjSet ((int (*)(int,int,char)) 0x80766E9) // to emit various objects ; a1 = Y, a2 = X, a3 = ID of object

const unsigned char coolDownTimeInit[] = {70, 70, 45};
const unsigned char coolDownTime[] = {140, 140, 70};

void Rewritten_Sub_804D57C_EntityAI_0x60_Tmain_zako_snowman() {
    if (CurrentPassage == 5 && CurrentLevel == 0 && (CurrentRoomId == 1 || CurrentRoomId == 13)) {
        // Custom code
        switch ( CurrentEnemyData.CurEnemy_CurrentAnimationId ) {
            case Q_INITIAL:
                CurrentEnemyData.CurEnemy_usStatus |= 0x20u;
                CurrentEnemyData.CurEnemy_GuardAndDamageParam = NO_ATA_H;
                CurrentEnemyData.CurEnemy_SizeY0_Bottom = 48;
                CurrentEnemyData.CurEnemy_SizeY1_Top = 0;
                CurrentEnemyData.CurEnemy_SizeX_LeftRight = 32;
                CurrentEnemyData.CurEnemy_HitboxY0 = 104;
                CurrentEnemyData.CurEnemy_HitboxY1 = 0;
                CurrentEnemyData.CurEnemy_HitboxX0 = 44;
                CurrentEnemyData.CurEnemy_HitboxX1 = 40;
                CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = unk_83D155C;
                CurrentEnemyData.CurEnemy_RealFrameCountForCurrentAnimationFrame = 0;
                CurrentEnemyData.CurEnemy_CurrentAnimationFrameId = 0;

                CurrentEnemyData.CurEnemy_TWork0 = coolDownTimeInit[CurrentDifficulty];
                CurrentEnemyData.CurEnemy_CurrentAnimationId = JITTO;
                Sub_8026308_WarioOrientedStart();
                break;
            case JITTO:
                if (CurrentEnemyData.CurEnemy_TWork0 >= coolDownTime[CurrentDifficulty]) {
                    CurrentEnemyData.CurEnemy_TWork0 = 0;
                    Sub_8026308_WarioOrientedStart();
                    Sub_8001DA4_m4aSongNumStart(180);
                    if (CurrentEnemyData.CurEnemy_usStatus & 0x40) {
                        Sub_801E3A8_EnemyChildSet_LR(
                            ZAKO_SNOWMAN_REIKI,
                            CurrentEnemyData.CurEnemy_RoomEntitySlotId,
                            CurrentEnemyData.CurEnemy_ucChrOfs,
                            CurrentEnemyData.CurEnemy_YPos - 8,
                            CurrentEnemyData.CurEnemy_XPos + 24,
                            64);
                    } else {
                        Sub_801E3A8_EnemyChildSet_LR(
                            ZAKO_SNOWMAN_REIKI,
        ...
        // Vanilla code
        Sub_804D57C_EntityAI_0x60_Tmain_zako_snowman();
    }
}
